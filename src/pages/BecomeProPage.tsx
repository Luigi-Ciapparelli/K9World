...
const faqs = [
  ...
  {
    q: 'Serve partita IVA?',
    a: 'Dipende dal servizio e dalla tua situazione. PortaleCinofilo può raccogliere le informazioni, ma non sostituisce consulenza fiscale o legale.',
  },
];
        ...
        <div className="max-w-7xl mx-auto px-6 py-20 grid lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <p className="text-emerald-50 text-lg mt-6 max-w-xl">
              PortaleCinofilo aiuta educatori, addestratori, pensioni, dog sitter e dog walker
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid lg:grid-cols-3 gap-6">
          <div className="lg:col-span-1">
            <h2 className="text-3xl font-bold text-stone-900">Per chi è PortaleCinofilo?</h2>
